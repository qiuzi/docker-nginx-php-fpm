...
//基本设置--------------------------------------------------------------------------------------------
$_ENV['key']        = '1145148104934';                //!!! 瞎 jb 修改此key为随机字符串确保网站安全 !!!
$_ENV['debug']      = false;                          //正式环境请确保为 false
$_ENV['appName']    = 'ANGO';                      //站点名称
$_ENV['baseUrl']    = 'https://aupanel.herokuapp.com';               //站点地址
$_ENV['muKey']      = 'koibvgfx~gj47';                       //用于校验魔改后端请求，可以随意修改，但请保持前后端一致，否则节点不能工作！
...
$_ENV['db_socket']    = '';
$_ENV['db_database']  = 'sql3508671';           //数据库名
$_ENV['db_username']  = 'sql3508671';              //数据库用户名
$_ENV['db_password']  = 'vvpH9TzUNi';           //用户名对应的密码
#高级
...
//订阅设置---------------------------------------------------------------------------------------
$_ENV['Subscribe']                  = false;                         //本站是否提供订阅功能
...
#工单系统设置
$_ENV['enable_ticket']        = false;        //是否开启工单系统
